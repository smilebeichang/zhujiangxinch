 ...
 */
public interface QcTemplate2Mapper {
    ...
    List<RobotNavigationTreeNodeBean> searchRootTree();

    List<RobotNavigationTreeNodeBean> searchChildrenTree(String parentCode);
}
